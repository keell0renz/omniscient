...
import CardPopover from "@/components/application/projects/CardPopover";
import { Project } from "@prisma/client";
import ImportProject from "@/components/application/projects/ImportProject";

const ProjectCard = ({ project, isFromPublicPage }: { project: Project, isFromPublicPage?: boolean }) => {
    const { user } = useUser();
